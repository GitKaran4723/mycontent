...
## **Definition:**  DDL commands are used to **define, modify, or remove database structures** such as tables, indexes, schemas, or views. They deal with **database schema** rather than actual data.
...
## **Definition:**  DML commands **manipulate data** in existing tables — insert, update, delete, or call procedures.
...
## **Definition:**  DQL commands are used to **query and retrieve data** from a database. The primary command is `SELECT`.
...
## **Definition:**  DCL commands are used to **control access and permissions** on database objects.
...
## **Definition:**  TCL commands are used to **manage transactions** in the database. They ensure **data consistency** and integrity.
